...
title: Creating and submitting a mission
audience: customer
...
## How many missions can I have open at once?

There is no fixed limit stated for customers. Each mission is independent, with its own
quotes, assignment, evidence and report.

If you need work in several places or of several kinds, separate missions is the right
structure — one mission produces one assignment with one investigator.
