...
export const ru: Catalog = {
  ...
  missions: {
    empty: {
      ...
      body: 'Здесь появятся заказы, которые вы создали или над которыми работаете как детектив.',
    },
  },
  messages: {
    empty: {
      title: 'Переписки пока нет',
      body: 'Здесь появится переписка с детективами и заказчиками по заказам.',
    },
  },
  assistant: {
    empty: {
